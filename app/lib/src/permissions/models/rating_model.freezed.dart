...
abstract class $RatingModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String rating});
}
...
class _$RatingModelImpl with DiagnosticableTreeMixin implements _RatingModel {
  const _$RatingModelImpl({required this.id, required this.rating});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'RatingModel(id: $id, rating: $rating)';
  }
...
abstract class _RatingModel implements RatingModel {
  const factory _RatingModel(
      ...
      required final String rating}) = _$RatingModelImpl;
